  ...
  function TokenDropdown(ownedTokens?: OwnedToken[]) {
    ...
    return (
      <Menu as='div' className='relative inline-block text-left'>
        <MenuButton className='relative w-[15rem] inline-flex items-center justify-between rounded-md
          ...
          hover:bg-(--banner-bg-color) data-open:bg-(--banner-bg-color)'>
          {tokens.length} Tokens
          <ChevronDownIcon className='size-4' />
        </MenuButton>

        <MenuItems className='absolute left-0 origin-top-left z-10 overflow-auto
